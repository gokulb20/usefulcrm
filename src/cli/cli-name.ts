...
export const DEFAULT_CLI_NAME = "usefulcrm";

const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, "hermes"]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(usefulcrm|hermes)\b/;
