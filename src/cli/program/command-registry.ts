...
const CORE_CLI_ENTRIES: CoreCliEntry[] = [
  {
    name: "bootstrap",
    description: "Bootstrap UsefulCRM + Hermes and launch the web UI",
    register: ({ program }) => {
  ...
  {
    name: "update",
    description: "Update Useful web runtime without onboarding",
    register: ({ program }) => {
  ...
  {
    name: "stop",
    description: "Stop Useful managed web runtime",
    register: ({ program }) => {
  ...
  {
    name: "start",
    description: "Start Useful managed web runtime",
    register: ({ program }) => {
  ...
  {
    name: "restart",
    description: "Restart Useful managed web runtime",
    register: ({ program }) => {
