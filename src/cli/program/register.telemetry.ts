...
export function registerTelemetryCommand(program: Command) {
  const cmd = program
    .command("telemetry")
    .description("Manage anonymous telemetry for UsefulCRM");
  ...
  cmd
    ...
    .action(() => {
      ...
      console.log("\nLearn more: https://github.com/hermes/hermes/blob/main/TELEMETRY.md");
    });
  ...
  cmd
    ...
    .action(() => {
      ...
      console.log("You can re-enable it anytime with: npx usefulcrm telemetry enable");
    });
  ...
  cmd
    ...
    .action(() => {
      ...
      console.log("Telemetry has been enabled. Thank you for helping improve UsefulCRM!");
    });
  ...
  privacyCmd
    ...
    .action(() => {
      if (!isTelemetryEnabled()) {
        console.log("Telemetry is currently disabled. Enable it first with: npx usefulcrm telemetry enable");
        return;
      }
  ...
  privacyCmd
    ...
    .action(() => {
      ...
      console.log("Re-enable anytime with: npx usefulcrm telemetry privacy on");
    });
}
