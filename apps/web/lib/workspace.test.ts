...
describe("workspace utilities", () => {
  ...
  const STATE_DIR = join("/home/testuser", ".hermes-useful");
  ...
  describe("resolveWorkspaceRoot", () => {
    ...
    it("resolves bootstrap root workspace as useful default", async () => {
      delete process.env.OPENCLAW_WORKSPACE;
      const { resolveWorkspaceRoot, mockExists, mockReaddir } = await importWorkspace();
  ...
  describe("resolveWebChatDir", () => {
    it("falls back to root workspace chat dir for useful default", async () => {
      delete process.env.OPENCLAW_WORKSPACE;
