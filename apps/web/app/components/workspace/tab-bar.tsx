...
function tabToFaviconClass(tab: Tab, isLive: boolean): string | undefined {
  switch (tab.type) {
    case "home": return "useful-favicon-home";
    case "chat": return isLive ? "useful-favicon-chat-live" : "useful-favicon-chat";
    case "app": return "useful-favicon-app";
    case "cron": return "useful-favicon-cron";
    case "object": return "useful-favicon-object";
    default: return "useful-favicon-file";
  }
}
  ...
  return (
    <ContextMenu onOpenChange={(open) => {
      ...
      <ContextMenuTrigger asChild>
        <div
          ref={wrapperRef}
          className="useful-chrome-tabs-wrapper flex items-center shrink-0 relative"
