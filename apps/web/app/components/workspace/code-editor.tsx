...
function registerThemes(monaco: typeof import("monaco-editor")) {
	...
	monaco.editor.defineTheme("usefulcrm-light", {
		base: "vs",
		inherit: true,
		rules: [],
		colors: {
	...
	monaco.editor.defineTheme("usefulcrm-dark", {
		base: "vs-dark",
		inherit: true,
		rules: [],
		colors: {
...
function EditorInner({ content, filename, filePath, className, onDirty }: CodeEditorProps) {
	...
	const [theme, setTheme] = useState<string>(isDarkMode() ? "usefulcrm-dark" : "usefulcrm-light");
	...
	useEffect(() => {
		...
		const update = () => setTheme(isDarkMode() ? "usefulcrm-dark" : "usefulcrm-light");
	...
	const handleMount: OnMount = useCallback((ed, monaco) => {
		...
		monaco.editor.setTheme(isDarkMode() ? "usefulcrm-dark" : "usefulcrm-light");
