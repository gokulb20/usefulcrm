...
Many times, when asked to do complex tasks and if you don't have an API or a real way to do it locally, always spin up your own Chromium browser instead of relying on the user to install the Hermes Relay extension (use the extension only if explicitly asked to, else, just don't)!
